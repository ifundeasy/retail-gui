Ext.define('A.controller.location.National', {
    extend: 'Ext.app.Controller',
    views: ['location.National'],
    refs: [
        {ref: 'myGrid', selector: 'masterNational grid'},
        {ref: 'mySearchField', selector: 'masterNational checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterNational textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterNational textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterNational checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterNational actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterNational actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterNational toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterNational toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterNational toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterNational deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterNational selectRow')
    },
