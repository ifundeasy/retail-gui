Ext.define('A.controller.location.Regency', {
    ...
    refs: [
        ...
        {ref: 'mySearchField', selector: 'masterRegency checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterRegency textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterRegency textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterRegency checkboxlistcombo': {
            //change: 'filterGrid',
