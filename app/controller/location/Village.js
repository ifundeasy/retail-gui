Ext.define('A.controller.location.Village', {
    ...
    refs: [
        {ref: 'myGrid', selector: 'masterVillage grid'},
        {ref: 'mySearchField', selector: 'masterVillage checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterVillage textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterVillage textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterVillage checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterVillage grid dataview': {
            refresh: 'refreshView'
        },
        'masterVillage actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterVillage actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterVillage toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterVillage toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterVillage toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterVillage deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterVillage selectRow')
    },
