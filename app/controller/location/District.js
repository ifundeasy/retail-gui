Ext.define('A.controller.location.District', {
    extend: 'Ext.app.Controller',
    views: ['location.District'],
    refs: [
        {ref: 'myGrid', selector: 'masterDistrict grid'},
        {ref: 'mySearchField', selector: 'masterDistrict checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterDistrict textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterDistrict textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterDistrict checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterDistrict actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterDistrict actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterDistrict toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterDistrict toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterDistrict toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
