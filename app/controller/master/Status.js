Ext.define('A.controller.master.Status', {
    ...
    refs: [
        ...
        {ref: 'mySearchField', selector: 'masterStatus checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterStatus textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterStatus textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterStatus checkboxlistcombo': {
            //change: 'filterGrid',
