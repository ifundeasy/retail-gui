Ext.define('A.controller.master.Tag', {
    ...
    views: ['master.Tag'],
    refs: [
        {ref: 'myGrid', selector: 'masterTag grid'},
        {ref: 'mySearchField', selector: 'masterTag checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterTag textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterTag textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterTag checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterTag actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterTag actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterTag toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterTag toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterTag toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterTag deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterTag selectRow')
    },
