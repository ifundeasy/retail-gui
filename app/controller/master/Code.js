Ext.define('A.controller.master.Code', {
    ...
    views: ['master.Code'],
    refs: [
        {ref: 'myGrid', selector: 'masterCode grid'},
        {ref: 'mySearchField', selector: 'masterCode checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterCode textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterCode textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterCode checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterCode actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterCode actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterCode toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterCode toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterCode toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterCode deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterCode selectRow')
    },
