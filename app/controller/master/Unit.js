Ext.define('A.controller.master.Unit', {
    extend: 'Ext.app.Controller',
    views: ['master.Unit'],
    refs: [
        {ref: 'myGrid', selector: 'masterUnit grid'},
        {ref: 'mySearchField', selector: 'masterUnit checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterUnit textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterUnit textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterUnit checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterUnit actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterUnit actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterUnit toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterUnit toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterUnit toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterUnit deselectRow')
    },
