Ext.define('A.controller.master.Paymethod', {
    ...
    refs: [
        {ref: 'myGrid', selector: 'masterPaymethod grid'},
        {ref: 'mySearchField', selector: 'masterPaymethod checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterPaymethod textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterPaymethod textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterPaymethod checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterPaymethod actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterPaymethod actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterPaymethod toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterPaymethod toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterPaymethod toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
