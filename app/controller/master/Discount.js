Ext.define('A.controller.master.Discount', {
    extend: 'Ext.app.Controller',
    views: ['master.Discount'],
    refs: [
        {ref: 'myGrid', selector: 'masterDiscount grid'},
        {ref: 'mySearchField', selector: 'masterDiscount checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterDiscount textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterDiscount textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterDiscount checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterDiscount actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterDiscount actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterDiscount toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterDiscount toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterDiscount toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterDiscount deselectRow')
    },
