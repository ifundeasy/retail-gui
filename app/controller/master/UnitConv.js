Ext.define('A.controller.master.UnitConv', {
    extend: 'Ext.app.Controller',
    views: ['master.UnitConv'],
    refs: [
        {ref: 'myGrid', selector: 'masterUnitConv grid'},
        {ref: 'mySearchField', selector: 'masterUnitConv checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterUnitConv textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterUnitConv textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterUnitConv checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterUnitConv grid dataview': {
            refresh: 'refreshView'
        },
        'masterUnitConv actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterUnitConv actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterUnitConv toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterUnitConv toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterUnitConv toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterUnitConv deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterUnitConv selectRow')
    },
