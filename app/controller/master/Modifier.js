Ext.define('A.controller.master.Modifier', {
    extend: 'Ext.app.Controller',
    views: ['master.Modifier'],
    refs: [
        {ref: 'myGrid', selector: 'masterModifier grid'},
        {ref: 'mySearchField', selector: 'masterModifier checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterModifier textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterModifier textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterModifier checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterModifier grid dataview': {
            refresh: 'refreshView'
        },
        'masterModifier actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterModifier actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterModifier toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterModifier toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterModifier toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterModifier deselectRow')
    },
