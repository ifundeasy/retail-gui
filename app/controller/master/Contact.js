Ext.define('A.controller.master.Contact', {
    extend: 'Ext.app.Controller',
    views: ['master.Contact'],
    refs: [
        {ref: 'myGrid', selector: 'masterContact grid'},
        {ref: 'mySearchField', selector: 'masterContact checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterContact textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterContact textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterContact checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterContact grid dataview': {
            refresh: 'refreshView'
        },
        'masterContact actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterContact actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterContact toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterContact toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterContact toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterContact deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterContact selectRow')
    },
