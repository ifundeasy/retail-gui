Ext.define('A.controller.transc.PurchaseUnitWindow', {
    extend: 'Ext.app.Controller',
    views: ['transc.PurchaseUnitWindow'],
    refs: [
        {ref: 'window', selector: 'purchaseUnitWindow'},
        {ref: 'buttonsPanel', selector: 'purchaseUnitWindow panel[todo="buttons"]'},
        {ref: 'priceLbl', selector: 'purchaseUnitWindow panel[todo="buttons"] toolbar label[todo="price"]'},
        {ref: 'discountLbl', selector: 'purchaseUnitWindow panel[todo="buttons"] toolbar label[todo="discounts"]'},
        {ref: 'nettpriceLbl', selector: 'purchaseUnitWindow panel[todo="buttons"] toolbar label[todo="nettprice"]'},
        {ref: 'buttonsPanel', selector: 'purchaseUnitWindow panel[todo="buttons"]'},
        {ref: 'qtyField', selector: 'purchaseUnitWindow numberfield[todo="qty"]'},
        {ref: 'closeBtn', selector: 'purchaseUnitWindow button[action="close"]'},
        {ref: 'addBtn', selector: 'purchaseUnitWindow button[action="add"]'}
    ],
    activeBtn: null,
    events: {
        'purchaseUnitWindow': {
        ...
        'purchaseUnitWindow numberfield[todo="qty"]': {
            change: 'calculate',
            specialkey: 'pressedEnter'
        },
        'purchaseUnitWindow panel[todo="buttons"] button': {
            click: 'clickUnitBtn'
        },
        'purchaseUnitWindow button[action=save]': {
            click: 'clickSaveBtn'
        },
        'purchaseUnitWindow button[action=close]': {
            click: 'clickCloseBtn'
        }
    },
