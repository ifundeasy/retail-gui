Ext.define('A.controller.role.Privilege', {
    extend: 'Ext.app.Controller',
    views: ['role.Privilege'],
    refs: [
        {ref: 'myGrid', selector: 'masterPrivilege grid'},
        {ref: 'mySearchField', selector: 'masterPrivilege checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterPrivilege textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterPrivilege textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterPrivilege checkboxlistcombo': {
            //change: 'filterGrid',
            afterrender: 'addedSearchField'
        },
        'masterPrivilege grid': {
            afterrender: 'addedGrid',
            deselect: 'deselectRow',
            select: 'selectRow'
        },
        'masterPrivilege grid dataview': {
            refresh: 'refreshView'
        },
        'masterPrivilege actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterPrivilege actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterPrivilege toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterPrivilege toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterPrivilege toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterPrivilege deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterPrivilege selectRow')
    },
