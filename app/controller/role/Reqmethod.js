Ext.define('A.controller.role.Reqmethod', {
    ...
    refs: [
        {ref: 'myGrid', selector: 'masterReqmethod grid'},
        {ref: 'mySearchField', selector: 'masterReqmethod checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterReqmethod textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterReqmethod textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterReqmethod checkboxlistcombo': {
            //change: 'filterGrid',
            afterrender: 'addedSearchField'
        },
        'masterReqmethod grid': {
            afterrender: 'addedGrid',
            deselect: 'deselectRow',
            select: 'selectRow'
        },
        'masterReqmethod grid dataview': {
            refresh: 'refreshView'
        },
        'masterReqmethod actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterReqmethod actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterReqmethod toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterReqmethod toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterReqmethod toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterReqmethod deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterReqmethod selectRow')
    },
