Ext.define('A.controller.role.Actor', {
    ...
    views: ['role.Actor'],
    refs: [
        {ref: 'myGrid', selector: 'masterActor grid'},
        {ref: 'mySearchField', selector: 'masterActor checkboxlistcombo'},
        {ref: 'mySearchValue', selector: 'masterActor textfield[todo=valueFilter]'}
    ],
    ready4Filter: true,
    events: {
        'masterActor textfield[todo=valueFilter]': {
            //change: 'filterGrid',
            specialkey: 'pressedEnter'
        },
        'masterActor checkboxlistcombo': {
            //change: 'filterGrid',
        ...
        'masterActor grid dataview': {
            refresh: 'refreshView'
        },
        'masterActor actioncolumn[todo="edit"]': {
            click: 'editRow'
        },
        'masterActor actioncolumn[todo="delete"]': {
            click: 'deleteRow'
        },
        'masterActor toolbar button[todo="add"]': {
            click: 'addRow'
        },
        'masterActor toolbar button[todo="delete"]': {
            click: 'deleteRows'
        },
        'masterActor toolbar button[todo="save"]': {
            click: 'saveRows'
        }
    },
    ...
    deselectRow: function (model, record, index) {
        console.log('masterActor deselectRow')
    },
    selectRow: function (model, record, index) {
        console.log('masterActor selectRow')
    },
